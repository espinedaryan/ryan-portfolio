...
const Navbar = () => {
  return (
    <div className='absolute top-0 right-0 flex justify-between items-center 2xl:h-[5rem] xl:h-[4rem] w-[30%] 2xl:p-8 xl:p-4 xl:text-sm bg-[#2a2a2a] rounded-tl-none rounded-br-none rounded-3xl'>
