...
const Profile = () => {
  ...
  return (
    <div className="flex flex-col justify-between items-center 2xl:gap-8 xl:gap-6 sticky top-0 shadow-md border border-[#2a2a2a] rounded-3xl min-h-0 w-[20%] bg-[#1e1e1e] 2xl:p-[2rem] xl:p-[1rem]">
      <div className="flex flex-col justify-between items-center gap-2 h-[50%] w-full">
        ...
        <Image
          ...
          width={500}
          height={500}
          className="h-[60%] w-[80%] rounded-3xl object-cover object-top shadow-md"
        />
